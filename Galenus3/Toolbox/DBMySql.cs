...
namespace ConsoleAppBelimed.Toolbox
{
    public static class DBMySql
    {
        ...
        public static bool Insert(JuMachineSensorValue aMachineSensorValue, long aMDNDX, MySqlConnection aConnection, string aSchema)
        {
            string sql = string.Format("INSERT INTO {0}.ORIS_MACHINESENSORVALUE (MDNDX, DTARGUMENT, STAGE, PHASE, MESSAGEREFERENCE, MESSAGE, " +
                "SENSOR1, SENSOR2, SENSOR3, SENSOR4, SENSOR5, SENSOR6, ZONEREFERENCE, DTCREATED) " +
                "VALUES(@MDNDX, @DTARGUMENT, @STAGE, @PHASE, @MESSAGEREFERENCE, @MESSAGE, " +
                "@SENSOR1, @SENSOR2, @SENSOR3, @SENSOR4, @SENSOR5, @SENSOR6, @ZONEREFERENCE, @DTCREATED)", aSchema);
            int rowCount = 0;
